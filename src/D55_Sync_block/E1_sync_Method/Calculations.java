package D55_Sync_block.E1_sync_Method;
...
public class Calculations {
    ...
    private List<Integer> seconList = new ArrayList<>();
    ...
    public synchronized void secondCalculation() {
        ...
        seconList.add(random.nextInt(200));
    }
...
long ended = System.currentTimeMillis();
        ...
        System.out.println("First list: " + firstList.size() + ", Second list: " + seconList.size() );
